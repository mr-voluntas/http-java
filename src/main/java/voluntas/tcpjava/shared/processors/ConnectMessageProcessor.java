...
public class ConnectMessageProcessor implements MessageProcessor {
  ...
  private Gson gson;
  private static final Logger LOGGER = Logger.getLogger(ConnectMessageProcessor.class.getName());

  public ConnectMessageProcessor(CopyOnWriteArrayList<Client> clients, Gson gson) {
