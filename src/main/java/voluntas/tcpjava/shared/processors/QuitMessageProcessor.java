...
public class QuitMessageProcessor implements MessageProcessor {

  private CopyOnWriteArrayList<Client> clients;
  private Gson gson;
  private static final Logger LOGGER = Logger.getLogger(QuitMessageProcessor.class.getName());

  public QuitMessageProcessor(CopyOnWriteArrayList<Client> clients, Gson gson) {
